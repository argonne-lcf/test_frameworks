...
BENCH_DIR=/lus/flare/projects/datasets/softwares/testing/huihuo_testing_frameworks/test_frameworks/functionality-tests/multi-node/test_incontext_benchmark
...
-bucket ${BUCKET} -ulysses_enable --logging --log_directory=${BENCH_DIR}/logs/${RUN_ID} --log_file=${RUN_ID}.log
